...
CREATE TABLE `education_info` (
  `edu_info_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `education_info_ibfk_1` FOREIGN KEY (`course_id`) REFERENCES `courses` (`course_id`),
  CONSTRAINT `education_info_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `personal_info` (`student_id`)
...
INSERT INTO `education_info` VALUES (1,'b.tech','jntu',89,1,1),(2,'b.tech','rgukt',89,1,2);
